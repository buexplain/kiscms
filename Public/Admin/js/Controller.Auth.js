...
function beforeEditName(treeId, treeNode) {
    window.location.href = '/Admin/Auth/addNode/node_id/'+treeNode.id+'.html';
}
/**
 * 删除节点之前
 */
...
function addHoverDom(treeId, treeNode) {
    ...
    if (btn) btn.bind("click",function() {
        window.location.href = '/Admin/Auth/addNode/pid/'+treeNode.id+'.html';
        return false;
    });
}
/**
